...
horas = 7
console.log(`${nome} agora são ${horas}  e voce tem que ir trabalhar e tem 3 opçõens `)
...
//ifs referentes a comer

if (respostapergunta1 == 2){
    fome = 100
    console.log(`você comeu e demorou 15mins agora seus status são fome:${fome}% saude:${saude}% `)
    addmins(15,0,0) 
console.log(" e então você foi para o  trabalho ")
console.log(" você foi trabalha e demorou 30 mins  para chegar até la ") 
addmins(30,0,0)
console.log(`você chegou ao trabalho e trabalhou muito bem por isso ganhou 100R$ `)
ganhos = ganhos + 100
fome = fome - 70
console.log("voce chegou em casa cansado apos trabalhar  o dia todo por isso você esta com muita fome" )
addmins(0,8,0)
console.log(`nesse momento seus status  estão em fome:${fome}% e saude: ${saude}%`)
...
if (numeroaleatorio >= 10)  {  
    chover() };
console.log(`você chegou ao trabalho e trabalhou muito bem por isso ganhou ${d1}R$ `)
ganhos = ganhos + d1
fome = fome - 70
console.log("voce chegou em casa cansado apos trabalhar  o dia todo por isso você esta com muita fome" )
addmins(0,8,0)
...
console.log( " voçe chegou  a 1000R$ de dinheiro e realizou seu sonho de comprar um celta de 4 portas rebaixado  e com som")
console.log("porem a policia te pegou e você apodreceu na cadeia ")
console.log(`você demorou ${dias} dias ${horas}horas e ${minutos}minutos para zerar o jogo`)